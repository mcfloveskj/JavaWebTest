...
_1f3.shadow=$("<div class=\"window-shadow\"><iframe style=\"position: absolute; z-index: -1;allowTransparency:true;background-color:#ffffff; width: 100%; height: 100%;scrolling:no;\" frameborder=\"0\"></iframe></div>").insertAfter(_1f3.window);
...
var _229="<div class=\"messager-box\">"+msg+"</div>";
switch(icon){
case "error":
...
var _70d=$("<div class=\"combo-panel\"><iframe style=\"position: absolute; z-index: -1; width: 100%; height: 100%; top: 0;left:0;scrolling:no\" frameborder=0></iframe></div>").appendTo("body");
